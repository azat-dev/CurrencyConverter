//
//  CurrencyConverterViewModelImpl.swift
//  CurrencyConverter
//
...
public final class CurrencyConverterViewModelImpl: CurrencyConverterViewModel {
    ...
    private var itemsById: [CurrencyCode: CurrencyConverterItemViewModel]?
    ...
    private static func groupById(
        currencies: [Currency],
        convertedValues: [CurrencyCode: Double]
    ) -> [CurrencyCode: CurrencyConverterItemViewModel] {

        return currencies.reduce(
            into: [CurrencyCode: CurrencyConverterItemViewModel]()
    ...
    public func getItem(for id: CurrencyCode) -> CurrencyConverterItemViewModel? {
