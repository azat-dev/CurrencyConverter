...
public final class MainFlowPresenterImpl: MainFlowPresenter {
    ...
    private func update(
        ...
        selectCurrencyFlowPresenter.present(inContainer: navigationController)
    }
    ...
    public func present(at window: UIWindow) {
        ...
        currencyConverterVC.viewModel = flowModel.currencyConverterViewControllerViewModel

        rootNavigationController.pushViewController(currencyConverterVC, animated: false)
