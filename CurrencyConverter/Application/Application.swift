...
public final class Application {
    ...
    static func makeFlowModel(settings: ApplicationSettings) -> MainFlowModel {
        ...
        guard let applicationDirectory = try? Self.getApplicationDirectory() else {
            fatalError("Can't get application directory")
        }
        ...
        let currencySelectionViewModelFactory = CurrencySelectionViewModelImplFactory(
        ...
        let currencyConverterViewModelFactory = CurrencyConverterViewModelImplFactory(
